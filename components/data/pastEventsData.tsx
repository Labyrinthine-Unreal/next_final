const pastEventsData = [
    {
        title: 'Art Contest',
        croppedDescription: (<>Animal Familiar...</>),
        description: (<>3D Animal Familiar Art Contest to feature in our upcoming game, <em>Labyrinthine Unreal</em><br /><br />Submissions open to all TaurosDAO members<br /><br/>Winner: Aragog<br /> by <a style={{color: "#2E7DAF"}} href='https://twitter.com/erfanashorion' target="blank">Eraserhead</a><br /></>),
        buttonText: 'View',
        imageUrl: 'images/game/Aragog.jpg',
        imageAlt: 'Aragog'
    },
    {
        title: 'The Bowels of Time',
        ...
        buttonText: 'Solution',
        imageUrl: 'images/game/Avatar.jpg',
    ...
    },
    {
        ...
        buttonText: 'Solution',
        imageUrl: 'images/puzzles/Ancient-Libraries.jpg',
        imageAlt: 'art-gallery',
