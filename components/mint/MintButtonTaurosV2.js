...
import {useToast,Link, NumberInputStepper, Button, Box, Spacer, NumberIncrementStepper, NumberDecrementStepper, NumberInputField, Text, FormControl, FormLabel, NumberInput} from "@chakra-ui/react"
                ...
                <form className={styles.btn} onSubmit={async e => {
                  ...
                  <FormControl my="4" maxW="210" minW="210">
                    ...
                    <NumberInput step={1} min={1} max={10} defaultValue={1} onChange={handleChange} allowMouseWheel>
                      <NumberInputField id="mintAmount" value={mintAmount} bg="gray.200" boxShadow="lg" />
