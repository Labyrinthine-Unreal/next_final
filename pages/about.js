...
export default function AboutPage() {
    return (
        <Box>
            ...
            Where things start to make more sense as an ecosystem is in the way we've structured our games: Merca City is an overworld and Labyrinthine Unreal is its underworld. These are both complete and separate games if you want them to be, yet if you hold the necessary assets to access them, you can seamlessly travel, advance, and save your progress between each of these intricate worlds.<br /><br />
