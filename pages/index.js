  ...
  return (
    <Box>
        ...
        <Text textStyle="landingPageContent">
            ...
            <br /><br />
            <span style={{fontWeight: "400"}}>Initiation Masks</span> are the genesis assets of Labyrinthine Unreal, and the players&apos; ticket to the private alpha stage of the game. As stated above, OGs have a 50% chance of receiving a free Initiation Mask for each token they own. Archons have a 25% and Guardians a 10% chance. All TAUROS holders will be automatically whitelisted for the sale, and those who own both a Mask and an Estate may move freely between worlds. Initiates will also be the first to receive the game&apos;s native token as rewards for completing tasks and/or solving various puzzles. The Labyrinth&apos;s game token is different from that of Merca City.
        </Text>
    </Box>
  );
}
