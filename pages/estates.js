                    ...
                    <TabPanels>
                        <TabPanel>
                            <UnorderedList fontSize="15px">
                                ...
                                <ListItem pt={6} fontWeight="semibold">Venues & Ticketed Events</ListItem>
            ...
            <Box textStyle="content">
                <Text>
                    ...
                    <List py={5} spacing="2">
                        ...
                        <Text color="gray.700" ml={6}>No one has ever waged open war on the mighty financial district, for that would bring upon their heads the wrath of all of Merca City&apos;s other districts which, as much as they resent its injustices and unfair practices, need its financial services. No one, that is, until now. The districts grew restless and either Pangaea or Bravio - the accounts differ depending on whom you ask - attacked and the uneasy balance was shattered. In the past there were always discontent citizens, but for the most part the interests of all were aligned and everyone was invested in Ritus in one way or another, including pirates and smugglers, who could not trade their ill gotten goods without their underhanded deals with its corrupt officials. For every resource, rare item, or gemstone found, mined, or outright stolen in Merca City must first pass through Ritus&apos; financial infrastructure in order to be minted as an NFT and traded in the open market. Now taxes and fees are enforced by whoever controls Ritus at the moment, and this fuels an endless war. The rest of the districts do not seem to mind it though, as in order to carry on the fight, the two military districts need a constant stream of resources, which the other districts happily provide in times of emergency. For a hefty price! In the dank recesses of the Labyrinth however, another dark insurgency is brewing, although no one knows if these are separate individuals, one faction or many.</Text>
                        <ListItem spacing={3} fontWeight="semibold" pt={5}>
                            <ListIcon as={ImEarth} />
                            Tauros
                        </ListItem>
