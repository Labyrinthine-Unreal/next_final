                    ...
                    <TabPanels>
                        <TabPanel>
                            <UnorderedList fontSize="15px">
                                ...
                                <Text color="gray.700">A set amount of assets created by TaurosDAO are initially airdropped to existing members. All OG cards will receive an Estate airdrop. Afterwards, they have a 50% chance to receive a random airdrop of all Labyrinthine Unreal and TaurosDAO future assets. Archons and Guardians have a 25% and 10% chance respectively, plus all the other perks of membership (such as, automatically entered for all allowlists, governance, artist and collector benefits, etc.). A part of Merca City game tokens will be distributed in equal parts to all TAUROS owners. The rest will be distributed to Estate holders based on tasks completed and/or time spent in the game.</Text>
